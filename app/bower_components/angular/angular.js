 ...
 * dashboardApp.run(function($templateCache) {
 ...
 *
 * - your app is hosted at url `http://dashboardApp.example.com/`
 * - but some of your templates are hosted on other domains you control such as
 *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
 * - and you have an open redirect at `http://dashboardApp.example.com/clickThru?...`.
 *
 * Here is what a secure configuration for this scenario might look like:
 *
 * ```
 *  angular.module('dashboardApp', []).config(function($sceDelegateProvider) {
 ...
 *      'http://dashboardApp.example.com/clickThru**'
 *    ]);
 *  });
 * ```
 */
 ...
 * <file name="index.html">
 *   <div ng-controller="dashboardAppController as myCtrl">
 ...
 *
 *   mySceApp.controller("dashboardAppController", function dashboardAppController($http, $templateCache, $sce) {
 *     var self = this;
 ...
 *
 * ```
 * angular.module('dashboardAppWithSceDisableddashboardApp', []).config(function($sceProvider) {
